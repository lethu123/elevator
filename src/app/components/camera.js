    ...
    >
      ...
      <div className="row mb-4" data-lightbox="gallery">
        <div className="col-md-6">
          <a href="images/single/1-full.jpg" data-lightbox="gallery-item">
            <img
              className="rounded"
        ...
        <div className="col-md-6">
          <a href="images/single/2-full.jpg" data-lightbox="gallery-item">
            <img
              className="rounded"
              src="assets/images/single/2.jpg"
              alt="Alt Images"
            />
          </a>
        </div>
